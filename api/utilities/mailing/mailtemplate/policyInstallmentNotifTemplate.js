...
const EmailTemplate = ({ policy, daysLeft }) => {
    let daysLftHdr = ''
    if (daysLeft === 1) daysLftHdr += `${daysLeft} day`;
    else if (daysLeft > 1) daysLftHdr += `${daysLeft} days`;
                    ...
                    React.createElement("thead", { key: "thead" },
                        React.createElement("tr", { className: "heading" }, [
                            React.createElement("th", { key: "tphdr", className: "tphdr" }, [
                                ...
                                React.createElement("span", { key: "rcpt", className: "rcpt" }, `${policy.recp_dtl.name}`),
                            ]),
                    ...
                    React.createElement("tbody", { key: "tbody", className: "main" }, [
                        React.createElement("tr", { key: "row1" },
                            React.createElement("td", { className: "paragraph", colSpan: 2 },
                                React.createElement("span", { className: "parahd" }, `Kindly check your Policy installment ${daysLftHdr} pending`)
                            )
                        ),
                            ...
                            React.createElement("td", { className: "dtlsec", colSpan: 2 }, [
                                ...
                                React.createElement("div", { key: "dtlbdy", className: "dtlbdy" }, [
                                    ...
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Premium Type: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.premiumType}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Premium Amount: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.premiumAmount}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "GST(Premium): "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.gstAmount}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Net Premium Amount: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.netPremiumAmount}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Installment Info: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.installmentFieldName}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Installment Amount: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.installmentAmount}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Installment GST: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.installmentGst}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Installment Date: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.installmentDate}`),
                                    ]),
                                    React.createElement("div", { key: "expdate" }, [
                                        React.createElement("span", { key: "exphd", className: "dtlhds" }, "Installment Note: "),
                                        React.createElement("span", { key: "expinf", className: "dtlinf" }, `${policy.installmentNote}`),
                                    ]),
                                ]),
                            ])
                        ),
...
export const genPolicyInstallmentMailnotif = async (policy, daysLeft) => {
