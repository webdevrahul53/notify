...
const DobEmailTemplate = ({ dob, imageCid }) => (
  <EmailLayout>
    <EmailHeader />
    <EmailBody dob={dob} imageCid={imageCid} />
    <EmailFooter />
  </EmailLayout>
);
...
export const genDobnotif = async (dob, imageCid) => {
  return await render(
    <DobEmailTemplate dob={dob} imageCid={imageCid} />
  );
};
